...
export default function Topbar() {
  ...
  return (
    <div style={{
      ...
      <motion.div
        animate={logoStable ? {
          filter: ['drop-shadow(0 0 0px #3ec87a)', 'drop-shadow(0 0 8px #3ec87a)', 'drop-shadow(0 0 0px #3ec87a)'],
      ...
      >
        ...
        <span style={{ fontFamily: 'DM Mono, monospace', fontSize: 10, color: 'var(--t3)', background: 'var(--p3)', padding: '1px 5px', borderRadius: 4 }}>⌘K</span>
      </button>
      ...
      {parts.length > 0 && (
        ...
        >
          ...
          <span style={{ fontFamily: 'DM Mono, monospace', fontSize: 11, color: physics?.stable ? 'var(--gr)' : physics ? 'var(--rd)' : 'var(--t2)' }}>
